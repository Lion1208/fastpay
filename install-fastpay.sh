...
echo -e "  • Ver logs:        ${YELLOW}bravepix-logs${NC}"
echo -e "  • Atualizar:       ${YELLOW}bravepix-update${NC}"
echo -e "  • Status:          ${YELLOW}systemctl status bravepix${NC}"
echo -e "  • Reiniciar:       ${YELLOW}systemctl restart bravepix${NC}"
